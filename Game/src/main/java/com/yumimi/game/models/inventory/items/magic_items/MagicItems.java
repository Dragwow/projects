...
@Getter
@Setter
public abstract class MagicItems extends StatBlock implements Item{
    ...
    private MagicType magicType;         // Тип магии

    private int price;

    public abstract void use();          // Использование в бою
    public abstract void events();      // Пасивка либо в бою либо не в бою , разные ивенты
